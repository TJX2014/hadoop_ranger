...
//            SupportState[] var1 = NativeIO.POSIX.SupportState.values();
//            int var2 = var1.length;
//
//            for(int var3 = 0; var3 < var2; ++var3) {
//                SupportState state = var1[var3];
...
//
//        private static native PmemMappedRegion pmemMapFile(String var0, long var1, boolean var3);
//
...
//            cacheTimeout = -1L;
//            cacheManipulator = new CacheManipulator();
//            if (NativeCodeLoader.isNativeCodeLoaded()) {
//                try {
